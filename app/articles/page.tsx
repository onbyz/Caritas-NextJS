import { ArticlesListPage } from "@/features/pages/CmsListPages";
import { STATIC_PAGE_REGISTRY } from "@/constants/pages/registry";
import { getArticlesResolved } from "@/services/cms";
...
export default async function Page() {
  ...
  if (!page) notFound();
  const items = await getArticlesResolved();
  return <ArticlesListPage page={page} items={items} />;
}
